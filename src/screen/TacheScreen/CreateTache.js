  ...
  const CreateTache = () => {
    ...
    const handleProjectChange = async (refProjet) => {
      setTacheData((prev) => ({ ...prev, ref_projet: refProjet, id_phase: "" }));
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        const message =
          ...
          "Erreur lors de la création ou de l'assignation.";
        setModalMessage(`Assignation refusée : Changez la date ou l’utilisateur`);
        setModalType("error");
        setIsModalOpen(true);
      } finally {
        setSubmitting(false);
    ...
    const handlePhaseChange = async (
      ...
      setTacheData((prev) => ({ ...prev, id_phase }));
          ...
          <div className="steps-header">
            <div className="steps-container">
              ...
              <div className={`step ${currentStep >= 2 ? "active" : ""}`}>
                ...
                <span className="step-label">Planification & Assignation</span>
              </div>
            </div>
          </div>
